...
public class IfElseIfElse {
    public static void main(String[] args) {
        ...
        char grade = 'B';
        if (grade == 'A') {
            System.out.println("Excellent work!");                        //char needs to have single quotes,however string dosen't have single, it does have double quotes
        } else if (grade == 'B') {
